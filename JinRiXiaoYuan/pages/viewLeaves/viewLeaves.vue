<template>
	<view class="container">
		...
		<view class="nav">
			<view class="nav-left">
				<image src="../../static/img/dt_store_back.png" @click="backPage()"></image>
				<image src="../../static/img/close.png" style="margin-left: 35rpx;width: 18px;height: 18px;" @click="backPage()"></image>
			</view>
